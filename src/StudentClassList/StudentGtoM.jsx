...
import { cardimagestudentlist, cardimagestudentlist2 } from "../image";
  ...
  return (
    <>
      <div className="bg-gray-100 mt-4 flex flex-wrap justify-between items-center">
        {[
          { src: cardimagestudentlist2, text: 'Greduation', href: 'greduation' },
          { src: cardimagestudentlist2, text: 'Masters', href: 'masters' },
